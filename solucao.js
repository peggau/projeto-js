...
function somaEstoque() {
    const total = listaProdutos.reduce((total, produto) => {
        return total + produto.qtdEstoque;
    }, 0);
    console.log('o total de produtos no estoque é: ', total);
};
...
///////////// Exercício 2 Quantidade total de itens em destaque
function somaDestaque() {
    const total = listaProdutos.reduce((total, produto) => {
...
///////////// Exercicio 4
function somaDisponiveisEDestaque() {
    const total = listaProdutos.reduce((total, produto) => {
...
somaDisponiveisEDestaque();





////////// Exercício 5 - Soma dos valores * qtdEstoque
function somaValorInventario() {
    const total = listaProdutos.reduce((total, produto) => {
        return total + (produto.preco * produto.qtdEstoque)
    }, 0);
    
    return total;
};
console.log('o total de valores em inventário é: ', somaValorInventario());





////////// Exercício 6 - Produto mais caro da loja

function maiorValor() {
    const maior = listaProdutos.reduce((prev, current) => (prev.preco > current.preco) ? prev : current)
    console.log('O maior valor é: ', maior.preco, ' e é do departamento: ', maior.departamento.nomeDepto);
}
...
////////// Exercício 7 - Produto mais barato da loja

function menorValor() {
    const menor = listaProdutos.reduce((prev, current) => (prev.preco < current.preco) ? prev : current)
    console.log('O menor valor é: ', menor.preco, ' e é do departamento: ', menor.departamento.nomeDepto);
}
...
/////// Exercício 8 - Produto mais valioso

function maisValioso() {
    const maior = listaProdutos.reduce((prev, current) => ((prev.preco * prev.qtdEstoque) > (current.preco * current.qtdEstoque)) ? prev : current)
    console.log('O mais valioso é: ', maior.descricao, ' e o seu total é: ', maior.preco * maior.qtdEstoque);
}
...
/////// Exercício 9 - Produto menos valioso


function menosValioso() {
    const menor = listaProdutos.reduce((prev, current) => {
        if (current.qtdEstoque !== 0) {
            return (prev.preco * prev.qtdEstoque < current.preco * current.qtdEstoque) ? prev : current
        }
        return prev
    });

    console.log('O menos valioso é: ', menor.descricao, ' e o seu total é: ', menor.preco * menor.qtdEstoque);
}
...
/////// Exercício 10 - ticketMedio


function ticketMedio() {

    console.log(`O valor do ticket médio é: ${somaValorInventario()/listaProdutos.length}`);
}
